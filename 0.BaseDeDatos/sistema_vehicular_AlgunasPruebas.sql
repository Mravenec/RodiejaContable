...
-- 6. POBLAR VEHÍCULOS 
-- ========================================
/* Vehículo 1 – Toyota Corolla gen12 agregando las nuevas variables de traccion transmision y combustible*/
INSERT INTO vehiculos (
    generacion_id, anio, precio_compra, costo_grua, comisiones,
    fecha_ingreso, estado, traccion, transmision, combustible
) VALUES (
    1, 2023, 10000000.00, 50000.00, 100000.00,
    CURRENT_DATE(), 'DISPONIBLE', '4x2', 'Manual', 'Gasolina'
);
...
INSERT INTO vehiculos (
    ...
    CURRENT_DATE(), 'DESARMADO','4x2', 'Manual', 'Gasolina'
