...
public class VistaAuditoriaCompleta extends TableImpl<VistaAuditoriaCompletaRecord> {
     ...
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> CODIGO_ENTIDAD = createField(DSL.name("codigo_entidad"), SQLDataType.VARCHAR(20).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
