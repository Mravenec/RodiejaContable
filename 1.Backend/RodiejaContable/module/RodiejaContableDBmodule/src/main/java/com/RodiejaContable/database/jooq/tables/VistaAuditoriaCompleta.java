...
public class VistaAuditoriaCompleta extends TableImpl<VistaAuditoriaCompletaRecord> {
     ...
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> TIPO_ENTIDAD = createField(DSL.name("tipo_entidad"), SQLDataType.VARCHAR(11).nullable(false).defaultValue(DSL.inline("''", SQLDataType.VARCHAR)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.entidad_id</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> ENTIDAD_ID = createField(DSL.name("entidad_id"), SQLDataType.VARCHAR(15).defaultValue(DSL.inline("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.codigo_entidad</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> CODIGO_ENTIDAD = createField(DSL.name("codigo_entidad"), SQLDataType.VARCHAR(20).defaultValue(DSL.inline("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.descripcion_entidad</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> DESCRIPCION_ENTIDAD = createField(DSL.name("descripcion_entidad"), SQLDataType.CLOB.defaultValue(DSL.inline("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.accion</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> ACCION = createField(DSL.name("accion"), SQLDataType.VARCHAR(6).nullable(false).defaultValue(DSL.inline("''", SQLDataType.VARCHAR)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.campo_modificado</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> CAMPO_MODIFICADO = createField(DSL.name("campo_modificado"), SQLDataType.VARCHAR(50).defaultValue(DSL.inline("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.valor_anterior</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> VALOR_ANTERIOR = createField(DSL.name("valor_anterior"), SQLDataType.CLOB.defaultValue(DSL.inline("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.valor_nuevo</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> VALOR_NUEVO = createField(DSL.name("valor_nuevo"), SQLDataType.CLOB.defaultValue(DSL.inline("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.usuario</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> USUARIO = createField(DSL.name("usuario"), SQLDataType.VARCHAR(100).defaultValue(DSL.inline("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.fecha_cambio</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, LocalDateTime> FECHA_CAMBIO = createField(DSL.name("fecha_cambio"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.inline("NULL", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column
     * <code>sistema_vehicular.vista_auditoria_completa.observaciones</code>.
     */
    public final TableField<VistaAuditoriaCompletaRecord, String> OBSERVACIONES = createField(DSL.name("observaciones"), SQLDataType.CLOB.defaultValue(DSL.inline("NULL", SQLDataType.CLOB)), this, "");

    private VistaAuditoriaCompleta(Name alias, Table<VistaAuditoriaCompletaRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private VistaAuditoriaCompleta(Name alias, Table<VistaAuditoriaCompletaRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `vista_auditoria_completa` as select 'Vehículo' AS `tipo_entidad`,concat('ID: ',`hv`.`vehiculo_id`) AS `entidad_id`,`vvc`.`codigo_vehiculo` AS `codigo_entidad`,concat(`vvc`.`marca`,' ',`vvc`.`modelo`,' ',`vvc`.`generacion`) AS `descripcion_entidad`,`hv`.`accion` AS `accion`,`hv`.`campo_modificado` AS `campo_modificado`,`hv`.`valor_anterior` AS `valor_anterior`,`hv`.`valor_nuevo` AS `valor_nuevo`,`hv`.`usuario` AS `usuario`,`hv`.`fecha_cambio` AS `fecha_cambio`,`hv`.`observaciones` AS `observaciones` from (`sistema_vehicular`.`historial_vehiculos` `hv` left join `sistema_vehicular`.`vista_vehiculos_completa` `vvc` on(`hv`.`vehiculo_id` = `vvc`.`id`)) union all select 'Repuesto' AS `tipo_entidad`,concat('ID: ',`hr`.`repuesto_id`) AS `entidad_id`,`vic`.`codigo_repuesto` AS `codigo_entidad`,concat(`vic`.`parte_vehiculo`,' - ',coalesce(`vic`.`descripcion`,'Sin desc.')) AS `descripcion_entidad`,`hr`.`accion` AS `accion`,`hr`.`campo_modificado` AS `campo_modificado`,`hr`.`valor_anterior` AS `valor_anterior`,`hr`.`valor_nuevo` AS `valor_nuevo`,`hr`.`usuario` AS `usuario`,`hr`.`fecha_cambio` AS `fecha_cambio`,`hr`.`observaciones` AS `observaciones` from (`sistema_vehicular`.`historial_repuestos` `hr` left join `sistema_vehicular`.`vista_inventario_completo` `vic` on(`hr`.`repuesto_id` = `vic`.`id`)) union all select 'Transacción' AS `tipo_entidad`,concat('ID: ',`ht`.`transaccion_id`) AS `entidad_id`,`vtc`.`codigo_transaccion` AS `codigo_entidad`,concat(`vtc`.`tipo_transaccion`,' - $',`vtc`.`monto`) AS `descripcion_entidad`,`ht`.`accion` AS `accion`,`ht`.`campo_modificado` AS `campo_modificado`,`ht`.`valor_anterior` AS `valor_anterior`,`ht`.`valor_nuevo` AS `valor_nuevo`,`ht`.`usuario` AS `usuario`,`ht`.`fecha_cambio` AS `fecha_cambio`,`ht`.`observaciones` AS `observaciones` from (`sistema_vehicular`.`historial_transacciones` `ht` left join `sistema_vehicular`.`vista_transacciones_completas` `vtc` on(`ht`.`transaccion_id` = `vtc`.`id`)) order by `fecha_cambio` desc"), where);
    }
     ...
     */
    @Override
    public VistaAuditoriaCompleta where(Condition condition) {
        return new VistaAuditoriaCompleta(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public VistaAuditoriaCompleta where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public VistaAuditoriaCompleta where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public VistaAuditoriaCompleta where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public VistaAuditoriaCompleta where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public VistaAuditoriaCompleta where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public VistaAuditoriaCompleta where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public VistaAuditoriaCompleta where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public VistaAuditoriaCompleta whereExists(Select<?> select) {
     ...
     */
    @Override
    public VistaAuditoriaCompleta whereNotExists(Select<?> select) {
